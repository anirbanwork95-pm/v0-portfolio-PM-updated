...
const experienceData: ExperienceEntry[] = [
  {
    ...
    location: 'Pune, India',
    responsibilities: [
      'Built subscription monetization models unlocking ₹11+ Cr ARR across subscription, add-ons, and revenue share',
      ...
      'Shipped AI beat planning engine for 500+ field agents, improving daily meeting throughput by 33%',
      'Developed RAG + LLM sales chatbot trained on 200+ doctor attributes, lifting meeting-to-sale conversion by 50%',
      'Designed credential verification and QC system processing 30,000+ doctor profiles, reducing fraudulent profiles by 30%',
